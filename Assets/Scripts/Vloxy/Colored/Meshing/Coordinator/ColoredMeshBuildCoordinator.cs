...
namespace CodeBlaze.Vloxy.Colored.Meshing.Coordinator {
    ...
    public class ColoredMeshBuildCoordinator : UniTaskMultiThreadedMeshBuildCoordinator<ColoredBlock> {
        ...
        protected override void PostProcess(List<MeshBuildJobData<ColoredBlock>> jobs) {
            jobs.ForEach(job => {
                if (((ColoredChunkData) job.Chunk.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.Chunk.Data).Compress();
                if (job.ChunkNX != null && ((ColoredChunkData) job.ChunkNX.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.ChunkNX.Data).Compress();
                if (job.ChunkNY != null && ((ColoredChunkData) job.ChunkNY.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.ChunkNY.Data).Compress();
                if (job.ChunkNZ != null && ((ColoredChunkData) job.ChunkNZ.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.ChunkNZ.Data).Compress();
                if (job.ChunkPX != null && ((ColoredChunkData) job.ChunkPX.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.ChunkPX.Data).Compress();
                if (job.ChunkPY != null && ((ColoredChunkData) job.ChunkPY.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.ChunkPY.Data).Compress();
                if (job.ChunkPZ != null && ((ColoredChunkData) job.ChunkPZ.Data).State == CompressedArray<ColoredBlock>.DataState.DECOMPRESSED) ((ColoredChunkData) job.ChunkPZ.Data).Compress();
            });
        }
